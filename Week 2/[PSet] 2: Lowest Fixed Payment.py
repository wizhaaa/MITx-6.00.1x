# #week 2 pset 2 paying debt off in a year with fixed monthly payment
...
# multiple of $10 and is the same for all months. Notice that it is possible for the 
# balance to become negative using this payment scheme, which is okay. A summary of the 
...
print("Lowest payment: " + str(low(balance, annualInterestRate)))
